...
> __NOTE:__
>
> **ListView** can place items longer than the physical boundaries. It will allow the content to scroll



```dart
import 'package:flutter/material.dart';
//note Listview - this allows you to scroll
...
<img src="./maimages/StatelessWidgets_ListView.png" style="zoom:80%;" />