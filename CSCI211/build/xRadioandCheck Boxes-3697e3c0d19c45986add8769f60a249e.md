...
<body>
  <div class="div1">
    ...
    <input type="checkbox" id="cb1" name="grp1" value="11" />
    <label for="cb1">check box 1</label><br />

    <input type="checkbox" id="cb2" name="grp1" value="22" />
    <label for="cb2">check box 2</label><br />

    <input type="checkbox" id="cb3" name="grp1" value="33" />
...
If you want, I can show a tiny “selector cheat sheet” using examples pulled directly from your HTML.
